...
public class FOPIControl {

    String reader = "{[<NL><NM><ZR><PM><PL>]" + 
                     " [<NL><NM><ZR><PM><PL>]" + 
                     " [<NL><NM><ZR><PM><PL>]" + 
                     " [<NL><NM><ZR><PM><PL>]" + 
                     " [<NL><NM><ZR><PM><PL>]}"; 

    String doubleChannelAdder = "{[<NL,NL><NL,NL><NL,NL><NM,NM><ZR,ZR>]" +
                                 " [<NL,NL><NL,NL><NM,NM><ZR,ZR><PM,PM>]" +
                                 " [<NL,NL><NM,NM><ZR,ZR><PM,PM><PL,PL>]" +
                                 " [<NM,NM><ZR,ZR><PM,PM><PL,PL><PL,PL>]" +
                                 " [<ZR,ZR><PM,PM><PL,PL><PL,PL><PL,PL>]}";

    String doubleChannelDifferentiator = "{[<ZR,ZR><PM,PM><PL,PL><PL,PL><PL,PL>]" +
                                         " [<NM,NM><ZR,ZR><PM,PM><PL,PL><PL,PL>]" +
                                         " [<NL,NL><NM,NM><ZR,ZR><PM,PM><PL,PL>]" +
                                         " [<NL,NL><NL,NL><NM,NM><ZR,ZR><PM,PM>]" +
                                         " [<NL,NL><NL,NL><NL,NL><NM,NM><ZR,ZR>]}";

    String doubleChannelDifferentiator2 = "{[<ZR,ZR><nm,nm><nl,nl><nl,nl><nl,nl>]" +
    ...
    long period = 10;
    FOThread plant = new FOThread(0.5, 0.7, 0.2, 0.3, period);
